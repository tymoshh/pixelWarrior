...
const std::list<std::string> authors {"main programmer : tymoshh", "main graphics designer : swagrid"};
const std::list<std::string> credits {"sdl2 - https://github.com/libsdl-org", "learned from - https://www.youtube.com/@TheBuilder"};
